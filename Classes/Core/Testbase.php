...
namespace TYPO3\Documentation\Screenshots\Core;
...
class Testbase
{
    ...
    public function setUpInstanceCoreLinks($instancePath): void
    {
        ...
        foreach ($entryPointsToSet as $source => $target) {
            ...
            $entryPointContent = (string)preg_replace(
                ...
                '\TYPO3\Documentation\Screenshots\Core\SystemEnvironmentBuilder::run(',
                $entryPointContent
            );
     ...
     * @throws \TYPO3\Documentation\Screenshots\Core\Exception
     */
